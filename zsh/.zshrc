...
#Load powerlevel10k configuration command
...
case `uname` in
  ...
  Linux) #Linux-only commands
      alias kassenbon="(cd /home/bababue/kassenbon/ && source .venv/bin/activate && pip install -r requirements.txt --quiet && python main.py)"
  ;;
esac
